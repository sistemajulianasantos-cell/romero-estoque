...
async function gerarContratoDocx() {
  ...
  try {
    ...
    salvarContrato({ nome, cpf, tipo, data, local, convidados:conv, hrInicio:hrIni, hrFim, equipe:dadosContrato.equipe, opcao, valorNum, parc1, parc2, status:'ativo', origem:'sistema' });
