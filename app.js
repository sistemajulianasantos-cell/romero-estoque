...
function rAnaliseConfig() {
  ...
  configBody.innerHTML = MESES.map((m, i) => {
    ...
    return `<tr style="border-bottom:1px solid #1E2333">
      ...
      <td style="padding:6px 8px"><input class="inp" type="number" style="width:120px" placeholder="R$" value="${h.fat||''}"
        onchange="salvarHistorico('${hKey}','fat',this.value)"></td>
      ...
      <td style="padding:6px 8px"><input class="inp" type="number" style="width:120px" placeholder="R$ meta" value="${mt.fat||''}"
        onchange="salvarMeta('${mKey}','fat',this.value)"></td>
    </tr>`;
  }).join('');
}
